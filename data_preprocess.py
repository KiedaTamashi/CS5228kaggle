...
def preprocess_all(X_path = "./Xtrain.csv", out_csv_name="Xtrain_pre.csv"):
    ...
    dfs = [Names, Banks, BankStates, NAICSs,ApprovalDates,ApprovalFYs,Terms,NoEmps,NewExists,CreateJobs,RetainedJobs,
           FranchiseCodes,UrbanRurals,RevLineCrs,LowDocs,DisbursementDates,Grosses]
...
if __name__=="__main__":
    preprocess_all(X_path="./Xtrain.csv", out_csv_name="Xtrain_pre.csv")
